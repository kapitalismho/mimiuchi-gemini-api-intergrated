  ...
  settings: {
    ...
    translation: {
      ...
      gemini: {
        ...
        system_prompt_placeholder: 'Enter custom translation instructions (optional)',
        cloud_notice: 'Gemini is a cloud-based translation service. Your text will be sent to Google servers.',
